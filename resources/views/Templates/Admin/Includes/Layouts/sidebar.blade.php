    ...
    <ul class="nav nav-pills flex-column mb-auto">
        @if (Auth::check())
            ...
            <li class="nav-item">
                ...
                {{ (request()->is('admin/masters*')) ? 'true' : 'false' }}
                ">
                    <svg class="bi pe-none me-2" style="vertical-align: -.125em;" width="16" height="16"><use xlink:href="#master"/></svg>
                    Master
                </button>
                <div class="{{ (request()->is('admin/masters*')) ? 'collapse show' : 'collapse' }} multi-collapse" id="masters-collapse">
            ...
            <li class="nav-item">
                ...
                {{ (request()->is('admin/inputs*')) ? 'true' : 'false' }}
                ">
                    <svg class="bi pe-none me-2" style="vertical-align: -.125em;" width="16" height="16"><use xlink:href="#input"/></svg>
                    Input
                </button>
                <div class="{{ (request()->is('admin/inputs*')) ? 'collapse show' : 'collapse' }} multi-collapse" id="inputs-collapse">
                    <ul class="list-unstyled fw-normal pb-1 small">
                        @if (Auth::user()->part == "Admin")
                        <li>
            ...
            <li class="nav-item">
                ...
                {{ (request()->is('admin/analysis*')) ? 'true' : 'false' }}
                ">
                    <svg class="bi pe-none me-2" style="vertical-align: -.125em;" width="16" height="16"><use xlink:href="#analysis"/></svg>
                    Analysis
                </button>
                <div class="{{ (request()->is('admin/analysis*')) ? 'collapse show' : 'collapse' }} multi-collapse" id="analysis-collapse">
                    <ul class="list-unstyled fw-normal pb-1 small">
                        <li>
