...
<html lang="en">
    <head>
        ...
        @include('Templates.Officer.Includes.Meta.meta')
        <!--TITLE-->
        @yield('title')
        <!--FONTS-->
        ...
        <!--CSS SOURCES IN OFFICER TEMPLATE ONLY-->
        @include('Templates.Officer.Includes.Sources.css')
    </head>
    <body>
        <!--SVG ICONS-->
        ...
        <div class="container-fluid overflow-hidden">
            <div class="row vh-100 overflow-auto">
                ...
                @include('Templates.Officer.Includes.Layouts.sidebar')
                <div class="col d-flex flex-column h-sm-100">
                    ...
                    <!--FOOTER-->
                    @include('Templates.Officer.Includes.Layouts.footer')
                </div>
            </div>
        </div>
        <!--MODALS IN EVERY TEMPLATES-->
        @include('Templates.Includes.Components.modal')
        <!--MODALS IN OFFICER TEMPLATE ONLY-->
        @include('Templates.Officer.Includes.Components.modal')
        <!--MODALS IN EACH PAGES-->
        @yield('modals')
        <!--OFFCANVAS IN EVERY TEMPLATES-->
        @include('Templates.Includes.Components.offcanvas')
        <!--OFFCANVAS IN OFFICER TEMPLATE ONLY-->
        @include('Templates.Officer.Includes.Components.offcanvas')
        <!--OFFCANVAS IN EACH PAGES-->
        @yield('offcanvas')
        <!--SCRIPTS (JS) IN EVERY TEMPLATES-->
        @include('Templates.Includes.Sources.js')
        <!--SCRIPTS (JS) IN OFFICER TEMPLATE ONLY-->
        @include('Templates.Officer.Includes.Sources.js')
