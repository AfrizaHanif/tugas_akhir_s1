<div class="d-flex flex-column flex-shrink-0 bg-body-tertiary" style="width: 4.5rem;">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
        <li class="nav-item">
            <a href="/officer" class="nav-link active py-3 border-bottom rounded-0" aria-current="page" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Dashboard"><use xlink:href="#dashboard"/></svg>
            </a>
        </li>
        <li>
            <a href="/officer/officers" class="nav-link py-3 border-bottom rounded-0" title="Pegawai" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Pegawai"><use xlink:href="#officer"/></svg>
            </a>
        </li>
        <li>
            <a href="/officer/scores" class="nav-link py-3 border-bottom rounded-0" title="Top 3" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Top 3"><use xlink:href="#score"/></svg>
            </a>
        </li>
        <li>
            <a href="/officer/votes" class="nav-link py-3 border-bottom rounded-0" title="Voting" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Voting"><use xlink:href="#vote"/></svg>
            </a>
        </li>
        <li>
            <a href="/officer/results" class="nav-link py-3 border-bottom rounded-0" title="Karyawan Terbaik" data-bs-toggle="tooltip" data-bs-placement="right">
                <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Karyawan Terbaik"><use xlink:href="#results"/></svg>
            </a>
        </li>
    </ul>
