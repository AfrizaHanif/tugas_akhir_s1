...
<html lang="en">
    <head>
        ...
        @include('Templates.Developer.Includes.Meta.meta')
        <!--TITLE-->
        @yield('title')
        <!--FONTS-->
        ...
        @include('Templates.Developer.Includes.Sources.css')
    </head>
    <body>
        <!--SVG ICONS-->
        ...
        <div class="container-fluid overflow-hidden">
            <div class="row vh-100 overflow-auto">
                ...
                @include('Templates.Developer.Includes.Layouts.sidebar')
                <div class="col d-flex flex-column h-sm-100">
                    ...
                    <!--FOOTER-->
                    @include('Templates.Developer.Includes.Layouts.footer')
                </div>
            </div>
        </div>
        ...
        @include('Templates.Developer.Includes.Components.modal')
        ...
        @include('Templates.Developer.Includes.Components.offcanvas')
        ...
        @include('Templates.Developer.Includes.Sources.js')
