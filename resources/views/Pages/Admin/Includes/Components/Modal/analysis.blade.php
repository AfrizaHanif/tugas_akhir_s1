                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto dropend">
                        ...
                        <ul class="dropdown-menu" style="max-height: 180px; overflow-y: auto;">
                            ...
                            <li><a class="dropdown-item" href="/admin/analysis/saw/{{ $period->id_period }}">{{ $period->period_name }}</a></li>
                            @empty
            ...
            <div class="modal-body">
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto dropend">
                        ...
                        <ul class="dropdown-menu" style="max-height: 180px; overflow-y: auto;">
                            @forelse ( $periods as $period )
                            <li><a class="dropdown-item" href="/admin/analysis/wp/{{ $period->id_period }}">{{ $period->period_name }}</a></li>
                            @empty
                            <li><a class="dropdown-item disabled" href="#" aria-disabled="true">Tidak ada data</a></li>
                            @endforelse
                        </ul>
