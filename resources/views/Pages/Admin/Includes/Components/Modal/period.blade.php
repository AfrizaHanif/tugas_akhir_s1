    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-per-create" action="{{ route('admin.masters.periods.store') }}" method="POST" enctype="multipart/form-data" id="form-per-create">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-per-create" class="btn btn-primary">
...
<div class="modal fade" id="modal-per-update-{{ $period->id_period }}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-per-update-{{ $period->id_period }}" action="{{ route('admin.masters.periods.update', $period->id_period) }}" method="POST" enctype="multipart/form-data" id="form-per-create">
                    @if (Session::get('modal_redirect') == 'modal-per-create')
                    @include('Templates.Includes.Components.alert')
                    @endif
                    @csrf @method('PUT')
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-per-update-{{ $period->id_period }}" class="btn btn-primary">
...
<div class="modal fade" id="modal-per-start-{{ $period->id_period }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-per-start-{{ $period->id_period }}" action="{{ route('admin.masters.periods.start', $period->id_period) }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-per-start-{{ $period->id_period }}" class="btn btn-primary">
...
<div class="modal fade" id="modal-per-delete-{{ $period->id_period }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-per-delete-{{ $period->id_period }}" action="{{ route('admin.masters.periods.destroy', $period->id_period) }}" method="POST" enctype="multipart/form-data">
                    @csrf @method('DELETE')
                    <div class="alert alert-warning" role="alert">
                        <i class="bi bi-exclamation-triangle-fill"></i> <b>PERHATIAN</b>
                        <br/>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-per-delete-{{ $period->id_period }}" class="btn btn-danger">
                    <i class="bi bi-check-lg"></i>
                    Ya
                </button>
            </div>
