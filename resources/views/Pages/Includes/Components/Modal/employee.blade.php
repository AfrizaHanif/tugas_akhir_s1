@if (Request::is('admin/masters/employees') || Request::is('developer/masters/employees'))
<!--IMPORT PEGAWAI-->
<div class="modal modal-lg fade" id="modal-emp-import" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-emp-import" action="{{ route('admin.masters.employees.import') }}" method="post" enctype="multipart/form-data">
                @elseif (Auth::user()->part == 'Dev')
                <form id="form-emp-import" action="{{ route('developer.masters.employees.import') }}" method="post" enctype="multipart/form-data">
                @endif
                    @csrf
                                                ...
                                                <label class="list-group-item d-flex gap-2">
                                                    ...
                                                    <span>
                                                        ...
                                                        <small class="d-block text-body-secondary">
                                                            Metode ini akan melakukan penambahan (Jika tidak terdaftar di sistem ini.) dan perubahan data karyawan dan pengguna (Jika terdaftar di sistem ini).
                                                        </small>
                                                    </span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    ...
                                                    <span>
                                                        Reset Data Karyawan
                                                        <small class="d-block text-body-secondary">
                                                            <strong>PERHATIAN: </strong>Pilihan ini akan menghapus seluruh data Karyawan, Pengguna, dan Input sebelum melakukan import. Baca perhatian di <b>CARA IMPORT</b>.
                                                        </small>
                                                    </span>
                                                </label>
                                            </div>
                                ...
                                <div class="alert alert-info" role="alert">
                                    ...
                                    <ol>
                                        ...
                                        <ul>
                                            ...
                                            <li>Untuk <b>is_hr</b>, isi kata "Ya" bagi karyawan yang tergabung dalam Kepegawaian. Jika tidak, isi kata "Tidak"</li>
                                        </ul>
                                        ...
                                        <ul>
                                            <li>Metode Reset akan menghapus semua data (Karyawan, Pengguna, dan Data Nilai).</li>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-emp-import" class="btn btn-primary">
...
<!--EXPORT PEGAWAI-->
<div class="modal modal-sheet p-4 py-md-5 fade" tabindex="-1" role="dialog" id="modal-emp-export">
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
            <form action="{{ route('admin.masters.employees.export') }}" method="post" enctype="multipart/form-data">
                <div class="modal-header border-bottom-0">
                    <h1 class="modal-title fs-5">Export Karyawan</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body py-0">
                    <p>Proses ini akan mengunduh Data Karyawan ke komputer anda. Anda dapat melakukan Import karyawan menggunakan file hasil Export Karyawan (Pastikan baca petunjuk Import terlebih dahulu).</p>
                </div>
                <div class="modal-footer flex-column align-items-stretch w-100 gap-2 pb-3 border-top-0">
                    @csrf
                    <button type="submit" class="btn btn-lg btn-primary" id="exportToastBtn">Export Karyawan</button>
...
<div class="modal modal-sheet p-4 py-md-5 fade" tabindex="-1" role="dialog" id="modal-emp-precre-{{ $part->id_part }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
            <div class="modal-header border-bottom-0">
            ...
            <div class="modal-body py-0">
                <p>Untuk mempercepat pengisian data karyawan, disarankan menggunakan Import dari Excel untuk memudahkan anda saat mengisi data. Anda dapat melakukan pengisian secara manual jika membutuhkan.</p>
            </div>
            <div class="modal-footer flex-column align-items-stretch w-100 gap-2 pb-3 border-top-0">
                <button type="button" class="btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#modal-emp-import">Import dari Excel (Disarankan)</button>
                <button type="button" class="btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#modal-emp-create-{{ $part->id_part }}">Isi Manual</button>
...
<!--CREATE EMPLOYEE-->
<div class="modal modal-lg fade" id="modal-emp-create-{{ $part->id_part }}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data Karyawan Bagian {{ $part->name }}</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-emp-create-{{ $part->id_part }}"></button>
            </div>
            <div class="modal-body">
                @if (Auth::user()->part == 'Admin')
                <form id="form-emp-create-{{ $part->id_part }}" action="{{ route('admin.masters.employees.store') }}" method="POST" enctype="multipart/form-data" id="form-emp-create-{{ $part->id_part }}">
                @else
                <form id="form-emp-create-{{ $part->id_part }}" action="{{ route('developer.masters.employees.store') }}" method="POST" enctype="multipart/form-data" id="form-emp-create-{{ $part->id_part }}">
                @endif
                    @csrf
                    <div class="row justify-content-center g-4">
                        <div class="col-md-7">
                            <div class="position-sticky" style="top: 0rem;">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="karyawan-{{ $part->id_part }}-tab" data-bs-toggle="tab" data-bs-target="#karyawan-{{ $part->id_part }}-tab-pane" type="button" role="tab" aria-controls="karyawan-{{ $part->id_part }}-tab-pane" aria-selected="false">Info Karyawan</button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="diri-{{ $part->id_part }}-tab-pane" role="tabpanel" aria-labelledby="diri-{{ $part->id_part }}-tab" tabindex="0">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="tel" class="form-control" id="phone" name="phone" value="{{ old('old_input.phone') }}" required>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                <label for="place_birth" class="form-label">Tempat Lahir</label>
                                                <input type="text" class="form-control" id="place_birth" name="place_birth" value="{{ old('old_input.place_birth') }}" required>
                                            </div>
                                            <div class="col">
                                                <label for="date_birth" class="form-label">Tanggal Lahir</label>
                                                <input type="date" class="form-control" id="date_birth" name="date_birth" value="{{ old('old_input.date_birth') }}" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                ...
                                                <select class="form-select" id="gender" name="gender" required>
                                                    ...
                                                    <option value="Laki-Laki" {{ old('old_input.gender') == 'Laki-Laki' ? 'selected' : null }}>Laki-Laki</option>
                                                    <option value="Perempuan" {{ old('old_input.gender') == 'Perempuan' ? 'selected' : null }}>Perempuan</option>
                                                </select>
                                            </div>
                                            <div class="col">
                                                ...
                                                <select class="form-select" id="religion" name="religion" required>
                                                    ...
                                                    <option value="Islam" {{ old('old_input.religion') == 'Islam' ? 'selected' : null }}>Islam</option>
                                                    <option value="Kristen" {{ old('old_input.religion') == 'Kristen' ? 'selected' : null }}>Kristen</option>
                                                    <option value="Budha" {{ old('old_input.religion') == 'Budha' ? 'selected' : null }}>Budha</option>
                                                    <option value="Hindu" {{ old('old_input.religion') == 'Hindu' ? 'selected' : null }}>Hindu</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="tab-pane fade" id="karyawan-{{ $part->id_part }}-tab-pane" role="tabpanel" aria-labelledby="karyawan-{{ $part->id_part }}-tab" tabindex="0">
                                        <br/>
                                        <div class="mb-3">
                                            <label for="id_employee" class="form-label">NIP (ID)</label>
                                            <input type="number" class="form-control" id="id_employee" name="id_employee" min="10000000" max="999999999" value="{{ old('old_input.id_employee') }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="email" class="form-label">E-Mail Karyawan</label>
                                            <input type="email" class="form-control" id="email" name="email" value="{{ old('old_input.email') }}" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="id_position" name="id_position" required>
                                                ...
                                                <option value="{{ $position->id_position }}" {{ old('old_input.id_position') ==  $position->id_position ? 'selected' : null }}>{{ $position->name }}</option>
                                                @endforeach
                                            ...
                                            <div class="col">
                                                ...
                                                <select class="form-select" id="id_sub_team_1" name="id_sub_team_1" required>
                                                    ...
                                                    @foreach ($team_lists->where('id_part', $part->id_part) as $team)
                                                        ...
                                                        <option value="{{ $subteam->id_sub_team }}" {{ old('old_input.id_sub_team_1') ==  $subteam->id_sub_team ? 'selected' : null }}>{{ $subteam->name }}</option>
                                                        @endforeach
                                                    @endforeach
                                                </select>
                                                @endif
                                            ...
                                            <div class="col">
                                                ...
                                                <select class="form-select" id="id_sub_team_2" name="id_sub_team_2">
                                                    ...
                                                    @foreach ($team_lists as $team)
                                                        <option disabled value="">---{{ $team->name }}---</option>
                                                        @foreach ($subteams->where('id_team', $team->id_team) as $subteam)
                                                        <option value="{{ $subteam->id_sub_team }}" {{ old('old_input.id_sub_team_2') ==  $subteam->id_sub_team ? 'selected' : null }}>{{ $subteam->name }}</option>
                                                        @endforeach
                                                    @endforeach
                                                </select>
                                                @endif
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" id="is_hr" name="is_hr" {{ old('old_input.is_hr') == '1' ? 'checked' : null }}>
                        ...
                        <div class="col-md-5">
                            <div class="position-sticky" style="top: 0rem;">
                                <div class="alert alert-info" role="alert">
                                    ...
                                    <ol>
                                        <li>Isi sesuai dengan data karyawan yang ada di BPS Jawa Timur</li>
                                        ...
                                        @if ($part->name == 'Umum')
                                        <li>Jika karyawan tersebut bergabung ke Kepegawaian, centangkan di bawah pilihan tim utama.</li>
                                        @endif
                                        <li>Proses ini juga dapat menambahkan pengguna oleh sistem.</li>
                                        <li>Periksa hasil kembali data karyawan sebelum ditambahkan ke aplikasi</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-emp-create-{{ $part->id_part }}" class="btn btn-primary">
                ...
                <div class="modal-body">
                    ...
                    @endif
                        ...
                        <div class="alert alert-warning" role="alert">
                            ...
                            <ul>
                                <li>Seluruh <strong>Data Nilai dari Karyawan</strong> yang tergabung dengan Tim ini akan terhapus.</li>
                                <li>Seluruh <strong>Karyawan</strong> yang tergabung dengan Tim ini akan terhapus.</li>
...
<div class="modal modal-sheet p-4 py-md-5 fade" tabindex="-1" role="dialog" id="modal-emp-preupd-{{ $employee->id_employee }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
            <div class="modal-header border-bottom-0">
            ...
            <div class="modal-footer flex-column align-items-stretch w-100 gap-2 pb-3 border-top-0">
                <button type="button" class="btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#modal-emp-import">Import dari Excel (Disarankan)</button>
                <button type="button" class="btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#modal-emp-update-{{ $employee->id_employee }}">Isi Manual</button>
                <button type="button" class="btn btn-lg btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
...
<!--UPDATE EMPLOYEE-->
<div class="modal modal-lg fade" id="modal-emp-update-{{ $employee->id_employee }}" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Ubah Data Karyawan ({{ $employee->id_employee }}) ({{ $employee->subteam_1->team->part->name }})</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                @if (Auth::user()->part == 'Admin')
                <form id="form-emp-update-{{ $employee->id_employee }}" action="{{ route('admin.masters.employees.update', $employee->id_employee) }}" method="POST" enctype="multipart/form-data">
                @else
                <form id="form-emp-update-{{ $employee->id_employee }}" action="{{ route('developer.masters.employees.update', $employee->id_employee) }}" method="POST" enctype="multipart/form-data">
                @endif
                    @csrf @method('PUT')
                    <div class="row justify-content-center g-4">
                        <div class="col-md-7">
                            <div class="position-sticky" style="top: 0rem;">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="diri-{{ $employee->id_employee }}-tab" data-bs-toggle="tab" data-bs-target="#diri-{{ $employee->id_employee }}-tab-pane" type="button" role="tab" aria-controls="didi-{{ $employee->id_employee }}-tab-pane" aria-selected="true">Data Diri</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="karyawan-{{ $employee->id_employee }}-tab" data-bs-toggle="tab" data-bs-target="#karyawan-{{ $employee->id_employee }}-tab-pane" type="button" role="tab" aria-controls="karyawan-{{ $employee->id_employee }}-tab-pane" aria-selected="false">Info Karyawan</button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="diri-{{ $employee->id_employee }}-tab-pane" role="tabpanel" aria-labelledby="diri-{{ $employee->id_employee }}-tab" tabindex="0">
                                        <br/>
                                        <div class="mb-3">
                                            <label for="name" class="form-label">Nama Karyawan</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="photo" class="form-label">Foto (Pas Foto)</label>
                                            <div class="input-group">
                                                <input type="file" class="form-control" name="photo" id="photo" value="{{ $employee->photo }}">
                                            </div>
                                            <div class="form-check">
                                    ...
                                    <div class="tab-pane fade" id="karyawan-{{ $employee->id_employee }}-tab-pane" role="tabpanel" aria-labelledby="karyawan-{{ $employee->id_employee }}-tab" tabindex="0">
                                        <br/>
                                        <div class="mb-3">
                                            <label for="id_employee" class="form-label">NIP (ID)</label>
                                            <input type="number" class="form-control" id="id_employee" name="id_employee" min="10000000" max="999999999" value="{{ $employee->id_employee }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="email" class="form-label">E-Mail Karyawan</label>
                                        ...
                                        <div class="mb-3" hidden>
                                            <label for="id_part" class="form-label" hidden>Bagian</label>
                                            <input type="text" class="form-control" id="id_part" name="id_part" value="{{ $employee->subteam_1->team->part->id_part }}" readonly hidden>
                                        </div>
                                        <div class="mb-3">
                                            <label for="id_position" class="form-label">Jabatan</label>
                                            <select class="form-select" id="id_position_{{ $employee->id_employee }}" name="id_position" required>
                                                <option selected disabled value="">---Pilih Jabatan---</option>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <label for="id_sub_team_1" class="form-label">Tim Fungsi Utama</label>
                                                <select class="form-select" id="id_sub_team_1_{{ $employee->id_employee }}" name="id_sub_team_1" required>
                                                    <option selected disabled value="">---Pilih Tim Fungsi---</option>
                                                    @foreach ($team_lists as $team)
                                                        <option disabled value="">---{{ $team->name }}---</option>
                                                        @foreach ($subteams->where('id_team', $team->id_team) as $subteam)
                                                        <option value="{{ $subteam->id_sub_team }}" {{ $employee->id_sub_team_1 ==  $subteam->id_sub_team ? 'selected' : null }}>{{ $subteam->name }}</option>
                                                        @endforeach
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col">
                                                <label for="id_sub_team_2" class="form-label">Tim Fungsi Cadangan</label>
                                                <select class="form-select" id="id_sub_team_2_{{ $employee->id_employee }}" name="id_sub_team_2">
                                                    <option selected value="">Tidak Ada</option>
                                                    @foreach ($team_lists as $team)
                                                        <option disabled value="">---{{ $team->name }}---</option>
                                                        @foreach ($subteams->where('id_team', $team->id_team) as $subteam)
                                                        <option value="{{ $subteam->id_sub_team }}" {{ $employee->id_sub_team_2 ==  $subteam->id_sub_team ? 'selected' : null }}>{{ $subteam->name }}</option>
                                                        @endforeach
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            @if ($employee->subteam_1->team->part->name == 'Umum')
                                            <div class="form-check">
                                                @if (!empty($users->where('nip', $employee->id_employee)->first()))
                                                    @if ($users->where('nip', $employee->id_employee)->first()->part == 'Admin')
                                                    ...
                                                    @endif
                                                @else
                                                <input class="form-check-input" type="checkbox" value="1" id="is_hr" name="is_hr">
                                                <label class="form-check-label" for="is_hr">
                                                    Apakah Merupakan Kepegawaian?
                                                </label>
                                                @endif
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-emp-update-{{ $employee->id_employee }}" class="btn btn-primary">
                    <i class="bi bi-pencil"></i>
                    Ubah
                </button>
            </div>
...
<div class="modal fade" id="modal-emp-delete-{{ $employee->id_employee }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Data Karyawan ({{ $employee->name }})</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                @if (Auth::user()->part == 'Admin')
                <form id="form-emp-delete-{{ $employee->id_employee }}" action="{{ route('admin.masters.employees.destroy', $employee->id_employee) }}" method="POST" enctype="multipart/form-data">
                @else
                <form id="form-emp-delete-{{ $employee->id_employee }}" action="{{ route('developer.masters.employees.destroy', $employee->id_employee) }}" method="POST" enctype="multipart/form-data">
                @endif
                    @csrf @method('DELETE')
                    <div class="mb-3" hidden>
                        <label for="id_part" class="form-label" hidden>Bagian</label>
                    ...
                    <div class="alert alert-warning" role="alert">
                        <i class="bi bi-exclamation-triangle-fill"></i> <b>PERHATIAN</b>
                        <br/>
                        Apakah anda ingin menghapus Karyawan dengan nama <b>{{ $employee->name }}</b>?
                        <ul>
                            <li>Data nilai dari seluruh periode yang dimiliki oleh Karyawan ini akan dihapus bersamaan.</li>
                        </ul>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" form="form-emp-delete-{{ $employee->id_employee }}" class="btn btn-danger">
                    <i class="bi bi-check-lg"></i>
                    Ya
                </button>
            </div>
...
@if (Auth::user()->part == 'Admin')
<!--RETIRE EMPLOYEE-->
<div class="modal fade" id="modal-emp-retire-{{ $employee->id_employee }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Nonaktifkan Karyawan ({{ $employee->name }})</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                @if (Auth::user()->part == 'Admin')
                <form id="form-emp-retire-{{ $employee->id_employee }}" action="{{ route('admin.masters.employees.retire', $employee->id_employee) }}" method="POST" enctype="multipart/form-data">
                @else
                <form id="form-emp-retire-{{ $employee->id_employee }}" action="{{ route('developer.masters.employees.retire', $employee->id_employee) }}" method="POST" enctype="multipart/form-data">
                @endif
                    @csrf
                    <div class="mb-3" hidden>
                        <label for="id_employee" class="form-label" hidden>NIP (ID)</label>
                        <input type="text" class="form-control" id="id_employee" name="id_employee" value="{{ $employee->id_employee }}" readonly hidden>
                    </div>
                    <div class="mb-3" hidden>
                        <label for="id_part" class="form-label" hidden>Bagian</label>
                        <input type="text" class="form-control" id="id_part" name="id_part" value="{{ $employee->subteam_1->team->part->id_part }}" readonly hidden>
                    ...
                    <div class="mb-3" hidden>
                        <label for="id_sub_team_1" class="form-label" hidden>Tim Utama</label>
                        <input type="text" class="form-control" id="id_sub_team_1" name="id_sub_team_1" value="{{ $employee->id_sub_team_1 }}" readonly hidden>
                    </div>
                    <div class="alert alert-warning" role="alert">
                        <i class="bi bi-exclamation-triangle-fill"></i> <b>PERHATIAN</b>
                        <br/>
                        Apakah anda ingin menonaktifkan Karyawan dengan nama <b>{{ $employee->name }}</b>?
                        <ul>
                            <li>Pastikan bahwa karyawan tersebut telah dinonaktifkan yang dikarenakan <b>pemecatan, perberhentian, atau pensiun</b>.</li>
                            <li>Nilai yang dimiliki oleh karyawan selama periode berjalan akan <b>terhapus</b>, namun nilai yang dimiliki dari periode sebelumnya <b>tidak akan dihapus</b>.</li>
                            <li>Detail data yang dimiliki oleh karyawan ini <b>tidak dapat diubah</b> setelah dinonaktifkan.</li>
                        </ul>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" form="form-emp-retire-{{ $employee->id_employee }}" class="btn btn-danger">
                    <i class="bi bi-check-lg"></i>
                    Ya
                </button>
            </div>
