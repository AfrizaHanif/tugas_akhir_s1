...
class PerformanceController extends Controller
{
    ...
    public function index()
    {
        ...
        $status = BetaPerformance::select('id_period', 'id_officer', 'status')->groupBy('id_period', 'id_officer', 'status')->get();
    ...
    public function update(Request $request)
    {
        ...
        foreach($subcriterias as $subcriteria){
            ...
            //UPDATE DATA
            if(BetaPerformance::where('id_performance', $id_performance)->exists()){
                BetaPerformance::where('id_performance', $id_performance)->update([
                    'input'=>$request->input($subcriteria->id_sub_criteria),
                    'status'=>'Pending',
                ]);
            }else{
    ...
    public function destroy(Request $request)
    {
        ...
        foreach($subcriterias as $subcriteria){
            ...
            //DELETE DATA
            BetaPerformance::where('id_performance', $id_performance)->delete();
        }
