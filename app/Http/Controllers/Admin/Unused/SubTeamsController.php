    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        if ($validator->fails()) {
            ...
            //RETURN TO VIEW
            return redirect()->route('admin.masters.employees.index')->withErrors($validator)->withInput(['tab_redirect'=>'pills-'.$request->id_part, 'modal_tab_redirect'=>'pills-'.$request->id_team])->with('modal_redirect', 'modal-stm-create')->with('id_redirect', $request->id_team)->with('code_alert', 3);
        }
