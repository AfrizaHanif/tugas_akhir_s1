...
class ReportController extends Controller
{
    ...
    public function analysis($month, $year)
    {
        ...
        $employees = HistoryInput::select('id_period', 'period_name', 'id_employee', 'employee_name', 'employee_position')
        ->groupBy('id_period', 'period_name', 'id_employee', 'employee_name', 'employee_position')
    ...
    public function fillPDF($file, $source, $output, $employee_name, $period_name, $now)
    {
        //SET TEMPLATE
        $fpdi = new Fpdi;
